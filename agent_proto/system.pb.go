...
type GetSystemServicesRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *GetSystemServicesRequest) Reset() {
	*x = GetSystemServicesRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetSystemServicesRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetSystemServicesRequest) ProtoMessage() {}

func (x *GetSystemServicesRequest) ProtoReflect() protoreflect.Message {
	mi := &file_system_proto_msgTypes[20]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetSystemServicesRequest.ProtoReflect.Descriptor instead.
func (*GetSystemServicesRequest) Descriptor() ([]byte, []int) {
	return file_system_proto_rawDescGZIP(), []int{20}
}

type GetSystemServicesResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	Message string               `protobuf:"bytes,1,opt,name=message,proto3" json:"message,omitempty"`
	Code    ResponseCode         `protobuf:"varint,2,opt,name=code,proto3,enum=agent_proto.ResponseCode" json:"code,omitempty"`
	List    []*SystemServiceInfo `protobuf:"bytes,3,rep,name=list,proto3" json:"list,omitempty"`
}

func (x *GetSystemServicesResponse) Reset() {
	*x = GetSystemServicesResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetSystemServicesResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetSystemServicesResponse) ProtoMessage() {}

func (x *GetSystemServicesResponse) ProtoReflect() protoreflect.Message {
	mi := &file_system_proto_msgTypes[21]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetSystemServicesResponse.ProtoReflect.Descriptor instead.
func (*GetSystemServicesResponse) Descriptor() ([]byte, []int) {
	return file_system_proto_rawDescGZIP(), []int{21}
}

func (x *GetSystemServicesResponse) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
func (x *GetSystemServicesResponse) GetCode() ResponseCode {
	if x != nil {
		return x.Code
	}
	return ResponseCode_OK
...
func (x *GetSystemServicesResponse) GetList() []*SystemServiceInfo {
	if x != nil {
		return x.List
	}
	return nil
...
func (x *SystemServiceInfo) GetState() string {
	if x != nil {
		return x.State
	}
	return ""
...
var file_system_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x64, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x53, 0x79, 0x73, 0x74,
	0x65, 0x6d, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x12, 0x25, 0x2e, 0x61, 0x67, 0x65,
	0x6e, 0x74, 0x5f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x47, 0x65, 0x74, 0x53, 0x79, 0x73, 0x74,
	0x65, 0x6d, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x1a, 0x26, 0x2e, 0x61, 0x67, 0x65, 0x6e, 0x74, 0x5f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e,
	0x47, 0x65, 0x74, 0x53, 0x79, 0x73, 0x74, 0x65, 0x6d, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
...
var file_system_proto_goTypes = []any{
	...
	(*GetSystemServicesRequest)(nil),  // 20: agent_proto.GetSystemServicesRequest
	(*GetSystemServicesResponse)(nil), // 21: agent_proto.GetSystemServicesResponse
	(*SystemServiceInfo)(nil),         // 22: agent_proto.SystemServiceInfo
	(ResponseCode)(0),                 // 23: agent_proto.ResponseCode
}
var file_system_proto_depIdxs = []int32{
	23, // 0: agent_proto.GetSysInfoResponse.code:type_name -> agent_proto.ResponseCode
	...
	23, // 7: agent_proto.UserListResponse.code:type_name -> agent_proto.ResponseCode
	...
	23, // 10: agent_proto.GetShellHistoryResponse.code:type_name -> agent_proto.ResponseCode
	...
	23, // 13: agent_proto.GetProcessListResponse.code:type_name -> agent_proto.ResponseCode
	...
	23, // 17: agent_proto.GetSystemServicesResponse.code:type_name -> agent_proto.ResponseCode
	22, // 18: agent_proto.GetSystemServicesResponse.list:type_name -> agent_proto.SystemServiceInfo
	0,  // 19: agent_proto.SystemService.GetSysInfo:input_type -> agent_proto.GetSysInfoRequest
	6,  // 20: agent_proto.SystemService.GetUserList:input_type -> agent_proto.UserListRequest
	11, // 21: agent_proto.SystemService.GetShellHistory:input_type -> agent_proto.GetShellHistoryRequest
	15, // 22: agent_proto.SystemService.GetProcessList:input_type -> agent_proto.GetProcessListRequest
	20, // 23: agent_proto.SystemService.GetSystemServices:input_type -> agent_proto.GetSystemServicesRequest
	1,  // 24: agent_proto.SystemService.GetSysInfo:output_type -> agent_proto.GetSysInfoResponse
	7,  // 25: agent_proto.SystemService.GetUserList:output_type -> agent_proto.UserListResponse
	12, // 26: agent_proto.SystemService.GetShellHistory:output_type -> agent_proto.GetShellHistoryResponse
	16, // 27: agent_proto.SystemService.GetProcessList:output_type -> agent_proto.GetProcessListResponse
	21, // 28: agent_proto.SystemService.GetSystemServices:output_type -> agent_proto.GetSystemServicesResponse
...
func file_system_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_system_proto_msgTypes[20].Exporter = func(v any, i int) any {
			switch v := v.(*GetSystemServicesRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_system_proto_msgTypes[21].Exporter = func(v any, i int) any {
			switch v := v.(*GetSystemServicesResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_system_proto_msgTypes[22].Exporter = func(v any, i int) any {
			switch v := v.(*SystemServiceInfo); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
